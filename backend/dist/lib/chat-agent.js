...
import { embedMessage, embedReport, countTokens, } from '../services/embedding.service.js';
import { addMessage, getRecentMessages, } from '../services/conversation.service.js';
...
export const handleChatTurn = async (conversationId, userId, userMessageContent, emit) => {
    // 1. Save user message
    ...
    for (const msg of [...recentMessages].reverse()) {
        ...
        if (historyTokens + tokens > MAX_HISTORY_TOKENS)
            break;
